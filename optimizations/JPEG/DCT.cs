...
namespace JPEG
{
    public class DCT
    {
        //Сейчас работает с конкретным цветом за раз
                ...
                (u, v) =>
                {
                    var sum = MathEx
                        .SumByTwoVariables(
                            ...
                            0, height,
                            (x, y) =>
                                BasisFunction(subMatrix[x, y], u, v, x, y, height, width));
            ...
            for (var y = 0; y < coeffs.GetLength(0); y++)
            {
                var sum = MathEx
                    .SumByTwoVariables(
                        ...
                        (u, v) => BasisFunction(coeffs[u, v], u, v, x, y, coeffs.GetLength(0), coeffs.GetLength(1)) *
                                  Alpha(u) * Alpha(v));
